...
# Vendored from astro-han/karpathy-llm-wiki tests (MIT, (c) 2026 Yuhan Lei).
# SCRIPT path adjusted: fixture lives one level deeper (tests/fixtures/)
# than upstream, so resolve three parents up to the repo scripts/ dir.
SCRIPT = Path(__file__).resolve().parent.parent.parent / "scripts" / "check_evidence.py"
...
EXAMPLES_DIR = Path(__file__).resolve().parent.parent.parent / "tests" / "fixtures" / "examples"
